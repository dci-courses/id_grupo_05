...
Dirígete a la siguiente página para comenzar con la aplicación de detección de manos y empieza a sumar con tus dedos: [Ir a la aplicación de sumas](nbs\proyecto_suma\suma.qmd)