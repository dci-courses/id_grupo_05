...
(function() {
  ...
  let video;
  let hands = [];
  let currentSum = generateRandomSum();
  ...
  const sketch = (p) => {
    ...
    function fingersRaised(fingers) {
      ...
      if (fingersRaised === currentSum) {
        document.getElementById('sum-box').style.borderColor = 'green';

        setTimeout(() => {
          document.getElementById('sum-box').style.borderColor = '#000';
